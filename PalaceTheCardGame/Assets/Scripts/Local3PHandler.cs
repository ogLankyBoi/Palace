...
public class Local3PHandler : MonoBehaviour
{
    ...
    IEnumerator Deal()
    {
        ...
        for (int i = 0; i < 52; i++)
        {
            GameObject newCard = Instantiate(cardPrefab, new Vector3(Screen.width/2 - 100, Screen.height/2 + 150, zOffset), Quaternion.identity);
        ...
        for (int i = 0; i < 9; i++)
        {
            ...
            {
                GameObject.Find(deck[i]).transform.position = new Vector3((Screen.width) / 5 + 75 - xOffset3, Screen.height/2 + 300 - xOffset3, 30);
        ...
        for (int i = 9; i < 27; i++)
        {
            ...
            if (i == 9 || i == 12 || i == 15 || i == 18 || i == 21 || i == 24)
            {
                GameObject.Find(deck[i]).transform.SetParent(playerArea.transform, true);
            }
            else if (i == 10 || i == 13 || i == 16 || i == 19 || i == 22 || i == 25)
            {
    ...
    void PickEndOfGameCards()
    {
        for (int i = 0; i < 6; i++)
        {
            playerArea.transform.GetChild(i).GetComponent<UpdateCardSprite3P>().faceUp = true;
            playerArea.transform.GetChild(i).GetComponent<DragDrop3P>().isDraggable = true;
        }
    }
            ...
            if (playerRound == 0)
            {
                if (playerDZ.transform.childCount == 3)
                {
                    while (playerDZ.transform.childCount != 0)
                    {
                        ...
                        GameObject.Find(tempCardName).GetComponent<DragDrop3P>().isDraggable = false;
                        xOffset += 200;
                    }
            ...
            else if (playerRound == 1)
            {
                if (playerDZ.transform.childCount == 0)
                {
                    ...
                    else
                    {
                        ...
                        while (playedCards.Count != 0)
                        {
                            ...
                            GameObject.Find(playedCards[0]).GetComponent<DragDrop3P>().isDraggable = true;
                ...
                else
                {
                    ...
                    while (playerDZ.transform.childCount != 0)
                    {
                        ...
                        GameObject.Find(tempName).transform.position = new Vector3(Screen.width/2 + 100, Screen.height/2 + 150, 0);
                        GameObject.Find(tempName).GetComponent<UpdateCardSprite3P>().faceUp = true;
                        GameObject.Find(tempName).GetComponent<DragDrop3P>().isDraggable = false;
                        ...
                        if (cardV == 'T' || cardsPlayed == 4 || (cardsPlayed == 3 && playedCards[playedCards.Count - 4][0] == cardV) || (cardsPlayed == 2 && playedCards[playedCards.Count - 3][0] == cardV && playedCards[playedCards.Count - 4][0] == cardV) || (cardsPlayed == 1 && playedCards[playedCards.Count - 2][0] == cardV && playedCards[playedCards.Count - 3][0] == cardV && playedCards[playedCards.Count - 4][0] == cardV))
                        {
                            ...
                            else if (playerArea.transform.childCount == 0 && playerFinalCards.Count == 0)
                            {
                                if (playerLastUpCards.Count != 0)
                                {
                                    for (int i = 0; i < playerLastUpCards.Count; i++)
                                    {
                                        ...
                                        GameObject.Find(playerLastUpCards[i]).GetComponent<DragDrop3P>().isDraggable = true;
                                    }
                                }
                            ...
                            else if (playerArea.transform.childCount == 0 && topDeckCard == 52)
                            {
                                while (playerFinalCards.Count != 0)
                                {
                                    ...
                                    GameObject.Find(playerFinalCards[0]).GetComponent<UpdateCardSprite3P>().faceUp = true;
                                    GameObject.Find(playerFinalCards[0]).GetComponent<DragDrop3P>().isDraggable = true;
                            ...
                            else if (playerArea.transform.childCount < 3)
                            {
                                ...
                                while (j < cardsPlayed)
                                {
                                    if (topDeckCard <= 51 && playerArea.transform.childCount < 3)
                                    {
                                        ...
                                        GameObject.Find(deck[topDeckCard]).GetComponent<UpdateCardSprite3P>().faceUp = true;
                                        GameObject.Find(deck[topDeckCard]).GetComponent<DragDrop3P>().isDraggable = true;
                                        topDeckCard++;
                                        j++;
                                    }
                                    else
                ...
                if (playerDZ.transform.childCount == 0)
                {
                    ...
                    if (playerLastUpCards.Count != 0)
                    {
                        for (int i = 0; i < playerLastUpCards.Count; i++)
                        {
                            ...
                            GameObject.Find(playerLastUpCards[i]).GetComponent<DragDrop3P>().isDraggable = false;
                        }
                    }
                    playerRound = 1;
                    StartCoroutine(Computer1Turn());
    ...
    public IEnumerator FlipTopCard(int who)
    {
        ...
        GameObject.Find(deck[num]).transform.position = new Vector3(Screen.width/2 + 100, Screen.height/2 + 150, 0);
        GameObject.Find(deck[num]).GetComponent<UpdateCardSprite3P>().faceUp = true;
        ...
        if (check == false)
        {
            ...
            else if (who == 2)
            {
                while (playedCards.Count != 0)
                {
                    ...
                    GameObject.Find(playedCards[0]).GetComponent<DragDrop3P>().isDraggable = false;
                    GameObject.Find(playedCards[0]).GetComponent<UpdateCardSprite3P>().faceUp = false;
                    playedCards.RemoveAt(0);
                }
                lastPlayedCard = 'N';
    ...
    public IEnumerator Computer1Turn()
    {
        ...
        {
            playerDZ.transform.GetChild(i).GetComponent<DragDrop3P>().isDraggable = false;
        }
        yield return new WaitForSeconds(0.5f);
        if (computer1Round == 0)
        {
        ...
        else if (computer1Round == 1)
        {
            ...
            if (pos == true)
            {
                ...
                while (sameCards.Count != 0)
                {
                    ...
                    GameObject.Find(sameCards[0]).transform.position = new Vector3(Screen.width/2 + 100, Screen.height/2 + 150, 0);
                    GameObject.Find(sameCards[0]).GetComponent<UpdateCardSprite3P>().faceUp = true;
                    ...
                    if (bestCard[0] == 'T' || cardsP == 4 || (cardsP == 3 && playedCards[playedCards.Count - 4][0] == bestCard[0]) || (cardsP == 2 && playedCards[playedCards.Count - 3][0] == bestCard[0] && playedCards[playedCards.Count - 4][0] == bestCard[0]) || (cardsP == 1 && playedCards[playedCards.Count - 2][0] == bestCard[0] && playedCards[playedCards.Count - 3][0] == bestCard[0] && playedCards[playedCards.Count - 4][0] == bestCard[0]))
                    {
                        ...
                        else if (computer1Area.transform.childCount == 0 && topDeckCard == 52)
                        {
                            while (computer1FinalCards.Count != 0)
                            {
                                ...
                                GameObject.Find(computer1FinalCards[0]).GetComponent<UpdateCardSprite3P>().faceUp = false;
                                GameObject.Find(computer1FinalCards[0]).GetComponent<DragDrop3P>().isDraggable = false;
        ...
        else if (computer1Round == 2)
        {
            ...
            GameObject.Find(cardN).transform.position = new Vector3(Screen.width/2 + 100, Screen.height/2 + 150, 0);
            GameObject.Find(cardN).GetComponent<UpdateCardSprite3P>().faceUp = true;
            ...
            if (check == false)
            {
                ...
                if (computer1LastUpCards.Count != 0)
                {
                    ...
                    for (int i = 0; i < computer1LastUpCards.Count; i++)
                    {
                        ...
                        GameObject.Find(computer1LastUpCards[i]).transform.SetParent(canvas.transform, true);
                        GameObject.Find(computer1LastUpCards[i]).transform.position = new Vector3((Screen.width*4)/5 - (i * 75), Screen.height/2 + 150 + (i * 75), 0);
                        GameObject.Find(computer1LastUpCards[i]).GetComponent<DragDrop3P>().isDraggable = false;
                    }
                }
        ...
        for (int i = 0; i < playerDZ.transform.childCount; i++)
        {
            playerDZ.transform.GetChild(i).GetComponent<DragDrop3P>().isDraggable = true;
        }
    ...
    public IEnumerator Computer2Turn()
    {
        ...
        if (computer2Round == 0)
        {
            ...
            GameObject.Find(deck[topDeckCard]).transform.position = new Vector3(Screen.width/2 + 100, Screen.height/2 + 150, 0);
            GameObject.Find(deck[topDeckCard]).GetComponent<UpdateCardSprite3P>().faceUp = true;
                    ...
                    if (bestCard[0] == 'T' || cardsP == 4 || (cardsP == 3 && playedCards[playedCards.Count - 4][0] == bestCard[0]) || (cardsP == 2 && playedCards[playedCards.Count - 3][0] == bestCard[0] && playedCards[playedCards.Count - 4][0] == bestCard[0]) || (cardsP == 1 && playedCards[playedCards.Count - 2][0] == bestCard[0] && playedCards[playedCards.Count - 3][0] == bestCard[0] && playedCards[playedCards.Count - 4][0] == bestCard[0]))
                    {
                        ...
                        else if (computer2Area.transform.childCount == 0 && topDeckCard == 52)
                        {
                            while (computer2FinalCards.Count != 0)
                            {
                                ...
                                GameObject.Find(computer2FinalCards[0]).GetComponent<UpdateCardSprite3P>().faceUp = false;
                                GameObject.Find(computer2FinalCards[0]).GetComponent<DragDrop3P>().isDraggable = false;
        ...
        else if (computer2Round == 2)
        {
            if (computer2LastUpCards.Count != 0)
            {
                ...
                for (int i = 0; i < computer2LastUpCards.Count; i++)
                {
                    ...
                    GameObject.Find(computer2LastUpCards[i]).transform.position = new Vector3((Screen.width) / 5 + 75 - (75 * i), Screen.height/2 + 300 - (75 * i), 0);
            ...
            if (check == false)
            {
                ...
                if (computer2LastUpCards.Count != 0)
                {
                    ...
                    for (int i = 0; i < computer2LastUpCards.Count; i++)
                    {
                        ...
                        GameObject.Find(computer2LastUpCards[i]).transform.SetParent(canvas.transform, true);
                        GameObject.Find(computer2LastUpCards[i]).transform.position = new Vector3((Screen.width) / 5 + 75 - (75 * i), Screen.height/2 + 300 - (i * 75), 0);
                        GameObject.Find(computer2LastUpCards[i]).GetComponent<DragDrop3P>().isDraggable = false;
                    }
                }
    ...
    public void FindBestLastCards1()
    {
        ...
        for (int j = 0; j < 3; j++)
        {
            ...
            GameObject.Find(bestCards[j]).GetComponent<UpdateCardSprite3P>().faceUp = true;
    ...
    public void FindBestLastCards2()
    {
        ...
        {
            GameObject.Find(bestCards[j]).transform.SetParent(canvas.transform, true);
            GameObject.Find(bestCards[j]).transform.position = new Vector3((Screen.width) / 5 + 75 - xOffset, Screen.height/2 + 300 - xOffset, 0);
            GameObject.Find(bestCards[j]).GetComponent<UpdateCardSprite3P>().faceUp = true;
